...
export const cities: Record<CityId, City> = {
  ...
  moskva: { id: "moskva", name: "Moskva", x: 1833, y: 360 },
  munchen: { id: "munchen", name: "Munchen", x: 898, y: 618 },
  palermo: { id: "palermo", name: "Palermo", x: 1045, y: 1195 },
  ...
  rostov: { id: "rostov", name: "Rostov", x: 1920, y: 675 },
  sarajevo: { id: "sarajevo", name: "Sarajevo", x: 1245, y: 928 },
  sevastopol: { id: "sevastopol", name: "Sevastopol", x: 1740, y: 827 },
  smolensk: { id: "smolensk", name: "Smolensk", x: 1695, y: 424 },
  smyrna: { id: "smyrna", name: "Smyrna", x: 1535, y: 1195 },
